        ...
        >
          <div className="min-h-screen px-1 text-center md:px-4">
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Overlay className=" bg-neutral-900 bg-opacity-50 dark:bg-opacity-80" />
            </Transition.Child>
            ...
            >
              <div
                className={`inline-block w-full my-5 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-md sm:my-8 dark:bg-neutral-800 dark:border-neutral-700 text-neutral-900 dark:text-neutral-300 ${contentExtraClass}`}
              >
