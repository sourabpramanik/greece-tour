...
const ButtonSubmit2 = ({label, selectedVehicle}) => {
    const [loading, setLoading] = useState(false);

    const buttonClick = (selectedVehicle) => {
        if (selectedVehicle.uuid == null) {
            ...
            localStorage.setItem("selectedVehicle", saveOnLocal);
    ...
    return (
        ...
        >
            {!loading ?
                <span>{label}</span>
                :
                <svg role="status" className="w-6 h-6 text-gray-200 animate-spin dark:text-gray-400 fill-primary-6000"
